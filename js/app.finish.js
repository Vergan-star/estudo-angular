angular.module('website', ['ngAnimate'])
    ...
    .controller('MainCtrl', function ($scope) {
        $scope.pages = {
            'home': { label: 'Home', sublabel: 'Sublabel', content: 'Texto Home.' },
            'about': { label: 'About', sublabel: 'Sublabel', content: 'texto About.' },
            'contact': { label: 'Contact', sublabel: 'Sublabel', content: 'Texto Contato.' }
        };
        ...
        return {
            ...
            removeClass: function (element, className, done) {
                if (className == 'ng-hide') {
                    ...
                    TweenMax.fromTo(element, 0.5, { opacity: 0, left: -element.width() }, { opacity: 0.3, left: 0, onComplete: done });
                }
                else {
                    done();
                }
